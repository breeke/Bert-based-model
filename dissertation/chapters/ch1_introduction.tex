...
across virtually every class of software system.%
\footnote{National Institute of Standards and Technology, National Vulnerability Database
Statistics, \url{https://nvd.nist.gov/vuln/search/statistics}, accessed April 2024.}
The consequences of undetected vulnerabilities range from data breaches and service outages
to critical infrastructure compromise; the economic cost of software vulnerabilities
