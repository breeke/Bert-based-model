...
on comparable binary classification benchmarks~\citep{fu2022linevul,ni2023diversevul}.
...
GraphCodeBERT~\citep{guo2021graphcodebert} and graph-augmented vulnerability detectors
such as Devign~\citep{zhou2019devign} and Reveal~\citep{chakraborty2022reveal} --- have
...
Four directions would most directly address the identified limitations.
