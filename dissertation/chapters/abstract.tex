...
Token-level attribution analysis confirms this boundary: for CWE classes with locally
visible signals (CWE-416, CWE-798) the model attends to semantically correct tokens,
while for data-flow-dependent classes (CWE-78) attribution reveals reliance on
co-occurring surface tokens rather than the causal vulnerability pattern.
