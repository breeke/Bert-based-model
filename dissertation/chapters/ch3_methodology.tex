...
programming languages~\citep{guo2022unixcoder}.
...
C-specific classes include: buffer overflow (CWE-120), format string (CWE-134),
use-after-free (CWE-416), double free (CWE-415), integer overflow (CWE-190),
null pointer dereference (CWE-476), and off-by-one error (CWE-193).
Python-specific classes include: insecure deserialisation (CWE-502), prototype pollution
(CWE-1321), and regex denial-of-service (CWE-1333).
...
DiverseVul~\citep{ni2023diversevul}, which contains 200 real-world C functions and is
